...
| 주차      | 기간          | 과정명                 | 주요 내용                   | 학습 성과               |
| --------- | ------------- | ---------------------- | --------------------------- | ----------------------- |
| 1주차     | 04.23 ~ 04.25 | 🐍 **Python 기초&실습** | 자료형, 조건문, 반복문      | Python 기본 문법 마스터 |
| 2주차     | 04.28 ~ 05.02 | 🐍 **Python 기초&실습** | 함수, 클래스, 파일 입출력   | OOP 개념 이해 및 구현   |
| 3주차     | 05.07 ~ 05.08 | 🐍 **Python 기초&실습** | 실습 정리 및 종합           | 종합 프로젝트 완성      |
| 4주차     | 05.09 ~ 05.14 | 🧩 **Python 심화**      | 예외 처리, 모듈, 고급 문법  | 파이썬 고급 기능 활용   |
| 5주차     | 05.15         | 🤖 **인공지능 특강**    | AI 개요 및 산업 적용 사례   | AI 트렌드 이해          |
| 5주차     | 05.16 ~ 05.21 | 🛢️ **SQL 데이터 분석**  | SELECT, JOIN, GROUP BY      | 복잡한 쿼리 작성 능력   |
| 6주차     | 05.22 ~ 05.23 | 🛠️ **Git 협업툴**       | Git 기본, GitHub 활용       | 버전 관리 능력 습득     |
| 6주차     | 05.26         | 🤖 **인공지능 특강**    | AI 윤리, 활용 사례          | AI 윤리 이해            |
| 6주차     | 05.27         | 💼 **취업특강**         | 이력서, 포트폴리오 전략     | 취업 전략 수립          |
| 7주차     | 05.28 ~ 06.03 | 🧹 **클린코드**         | 리팩토링, 네이밍, 코드 구조 | 코드 품질 향상          |
| 8~10주차  | 06.04 ~ 06.18 | 🧮 **알고리즘 실습**    | 정렬, 탐색, DP, 구현 등     | 문제 해결 능력 강화     |
| 11주차    | 06.19         | 🤖 **인공지능 특강**    | 고급 AI 주제                | 최신 AI 기술 이해       |
| 11~12주차 | 06.20 ~ 06.24 | 🌐 **웹서비스**         | HTML/CSS/JS 프론트엔드      | 프론트엔드 개발 능력    |
| 12주차    | 06.25 ~ 06.27 | 🖥️ **웹서버**           | Flask, Django 백엔드        | 백엔드 개발 능력        |
| 13주차    | 06.30 ~ 07.03 | 🧠 **딥러닝 이론**      | 신경망 수식 및 개념         | DL 이론적 기초 확립     |
| 14주차    | 07.04 ~ 07.10 | 📊 **머신러닝**         | 분류/회귀, 모델 평가        | ML 알고리즘 이해        |
| 15~20주차 | 07.11 ~ 08.21 | 🔥 **딥러닝 (PyTorch)** | CNN, RNN, NLP 등 실전       | DL 모델 구현 능력       |
| 21주차    | 08.22 ~ 08.26 | 🔁 **딥러닝 정리**      | 복습 및 프로젝트 준비       | 학습 내용 체화          |
| 22~28주차 | 08.27 ~ 09.22 | 🚀 **파이널 프로젝트**  | 기획 → 개발 → 발표          | 실무 프로젝트 경험      |
